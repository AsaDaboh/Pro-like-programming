...
namespace AccessToFlatTest
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            //string cnnst = "Provider=Microsoft.jet.OLEDB.4.0;Persist Security Info=False;Data Source=C:\\Program Files (x86)\\NxTrain\\Sitec\\Resource\\DB\\test.mdb;";
            //OleDbConnection cnn = new OleDbConnection(cnnst);
            ////cnn.
            ////cnn.Open();
            //string sql = "select * from TblBaseObject";

            //OleDbDataAdapter cmd = new System.Data.OleDb.OleDbDataAdapter(sql, cnn);
            ...
            ////works prints out 1 table of data to xml
            //try
            //{
            //    OleDbConnection dbconn;
            //    OleDbCommand dbcomm;
            //    dbconn = new OleDbConnection("Provider=Microsoft.Jet.OLEDB.4.0;data source=C:\\Program Files (x86)\\NxTrain\\Sitec\\Resource\\DB\\test.mdb;Jet OLEDB:Database Password=996633;");
            //    OleDbDataAdapter dAd = new OleDbDataAdapter("SELECT * FROM TblBaseObject", dbconn);
            //    System.Data.DataTable dt = new System.Data.DataTable();
            //    dAd.Fill(dt);
            //    dt.TableName = "contestants";
            //    dt.WriteXml("contestants.xml");
            //}
            //catch (Exception ex)
            //{
            ...
            try
            {
                ...
                OleDbConnection dbconn = new OleDbConnection("Provider=Microsoft.Jet.OLEDB.4.0;data source=sitec2001.mdb;Jet OLEDB:Database Password=996633;");
                dbconn.Open();
                System.Data.DataTable schema = dbconn.GetSchema("Tables");

                schema.WriteXml("tables.xml");
                ...
                {
                    //Need to implement conversion of this into a text editor. 
                    if (tableName.StartsWith("Tbl"))
                    {


                        OleDbDataAdapter dAd = new OleDbDataAdapter("SELECT * FROM " + tableName, dbconn);
                        System.Data.DataTable dt = new System.Data.DataTable();
                        dAd.Fill(dt);
                        dt.TableName = tableName;
                        dt.WriteXml("test_" + tableName + ".xml");
                        ...
                        foreach (System.Data.DataRow row in dt.Rows)
                        {
                            ...
                            foreach (object itemData in row.ItemArray)
                            {
                                Console.Write("{0},", itemData);
                ...
                var m_objExcel = new Excel.Applicatoin();
        ...
        private string m_strNorthwind = "C:\\Program Files (x86)\\NxTrain\\Sitec\\Resource\\DB\\test.mdb";
